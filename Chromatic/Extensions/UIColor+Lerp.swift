...
extension UIColor {
    ...
    func lerp(currentColor: UIColor, finalColor: UIColor, progress: CGFloat) -> UIColor {
        let c1 = CGColorGetComponents(currentColor.CGColor)
        let c2 = CGColorGetComponents(finalColor.CGColor)
